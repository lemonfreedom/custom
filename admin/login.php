    ...
    <div class="row">
        <div class=" col-12 col-lg-4 offset-lg-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form action="<?= site_url('/user/login') ?>" method="POST">
                        <div class="mb-3">
                            <label class="form-label" for="">电子邮件地址</label>
                            <input class="form-control" name="account" type="text" autofocus placeholder="电子邮件地址">
                        </div>
                        <div class="mb-3">
                            <label class="form-label d-flex justify-content-between" for="">
                                <span>密码</span>
                                <a href="">忘记密码？</a>
                            </label>
            ...
            <div class="my-3 text-center">
                ...
                <a href="<?= base_url('/admin/register.php') ?>">立即注册</a>
            </div>
            <!-- <div class="mb-2 d-grid gap-2">
